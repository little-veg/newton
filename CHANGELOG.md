...
- Make the LIMX Franka scene grasp active cloth with 3 mm kinematic box contact and friction at one 0.01 s step per frame.
...
- Run the LIMX Franka cloth-drop example at 100 Hz with one 0.01 s step per rendered frame.
...
- Keep fast LIMX kinematic VF/EE candidates on their step-start side after crossing moving collider surfaces.
